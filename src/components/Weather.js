    ...
    render(){
        return(
            <div className="weather__info">
               ...
               {
               this.props.tempareture && <p className="weather__key">Tempareture: 
                <span className="weather__value">{this.props.tempareture}</span>   </p>
                   }
               {
               this.props.pressure && <p className="weather__key">Pressure: 
                  <span className="weather__value">{this.props.pressure}</span> </p>
                   }
               {
